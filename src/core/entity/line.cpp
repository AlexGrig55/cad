...
cad::Error::Code cad::entity::Line::readDXF(translator::DXFInput& reader) noexcept
{
	return cad::Error::Code::NoErr;
}

cad::Error::Code cad::entity::Line::writeDXF(translator::DXFOutput& reader) noexcept
{
	return cad::Error::Code::NoErr;
}
