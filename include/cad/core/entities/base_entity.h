...
#pragma region getters_setters
		...
		constexpr void	setLineType(const String& val)	noexcept { _lineType = val; }
...
#pragma region overrides
		...
		constexpr void setLayer(const String& name)		noexcept override { _layer = name; }
